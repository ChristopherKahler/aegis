...
Read .aegis/STATE.md phase progress. Check if Phases 0-4 are all complete. Phase 5 (Report) is the phase this command triggers, so it does not need to be complete as a prerequisite.
